...
def start_timer():
	...
	if reps % 8 == 0:
		...
		title_label.config(text="Break", font=(FONT_NAME, 35, "bold"), fg=RED)
	elif reps % 2 ==0:
		winsound.Beep(frequency, duration)
		count_down(short_break)
		title_label.config(text="Break", font=(FONT_NAME, 35, "bold"), fg=PINK)

	else:
		count_down(work_second)
		title_label.config(text="Work", font=(FONT_NAME, 35, "bold"), fg=GREEN)
